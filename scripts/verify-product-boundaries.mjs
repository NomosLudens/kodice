...
const TEXT_RULES = [
  ...
  { id: 'station-token-log',             pattern: /console\.(log|warn|error|info)[^;]{0,100}access.?token/i, rule: 'Token de acesso da Station em console proibido' },
  { id: 'station-token-localstorage',    pattern: /localStorage\.[^;]{0,100}access.?token/i,           rule: 'Token de acesso da Station em localStorage proibido' },
  { id: 'station-token-sessionstorage',  pattern: /sessionStorage\.[^;]{0,100}access.?token/i,         rule: 'Token de acesso da Station em sessionStorage proibido' },
  { id: 'station-token-indexeddb',       pattern: /dbPut[^;]{0,100}access.?token/i,                    rule: 'Token de acesso da Station em IndexedDB proibido' },
...
function checkJsRegressions(filePath, content) {
  ...
  // Checks
  if (content.includes('\x24\x24a(')) fail(filePath, 'Regressão JS global', 'Uso de 
